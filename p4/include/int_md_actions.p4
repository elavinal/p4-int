#ifndef __INT_MD_ACTIONS__
#define __INT_MD_ACTIONS__
#include "headers.p4"
...
//Creates the node_id header with matching metadata
    ...
    action add_lv2_if_id(headers hdr) {
        //v1model does not handle it
    ...
    action add_eg_if_tx_util(headers hdr) {
    ...
    action add_buffer_id_occupancy(headers hdr) {
